...
public class FeedReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + FeedReaderContract.FeedEntry.TABLE_NAME + " (" +
                    FeedReaderContract.FeedEntry.COLUMN_NAME_QUESTION_ID + " INTEGER PRIMARY KEY," +
                    FeedReaderContract.FeedEntry.COLUMN_NAME_ANSWER_ID + TEXT_TYPE + ")";
...
// How you want the results sorted in the resulting Cursor
        ...
        c.moveToLast();
            ...
            Log.d("", "DB RESULT QUESTION: " + question_id);
            Log.d("", "DB RESULT ANSWER: " + answer_id);
